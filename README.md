...
<body>
    ...
    <div class="container">
        ...
        <div id="community" class="content-box">
            ...
            <div class="community-main" id="communityMain">
                <p>작성자 닉네임: <b id="userNickname" style="color:#5bc0be;"></b></p>
    ...
    <script>
        ...
        function updateInfo() {
            ...
            if (newIndex) {
                document.getElementById('displayIndex').innerText = newIndex;
                localStorage.setItem('infoIndex', newIndex);
            }
            if (newTarget) {
                document.getElementById('displayTarget').innerText = newTarget;
                localStorage.setItem('infoTarget', newTarget);
            }
        ...
        function registerUser() {
            ...
            // userList 내부를 검사하여 똑같은 닉네임이 있는지 확인합니다.
            ...
            // 중복이 없다면 새 유저 정보를 리스트에 추가합니다.
            const newUser = { id: id, pw: pw, name: name };
            userList.push(newUser);
            
            // 로컬 스토리지에 유저 리스트를 통째로 저장합니다.
        ...
        function loginUser() {
            ...
            // 내가 입력한 아이디와 비밀번호가 일치하는 유저가 목록에 있는지 찾습니다.
